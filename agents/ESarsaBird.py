    ...
    def train(self, env, iter, iterPerEval, evalIter):
        ...
        for i in range(iter):
            ...
            while True:
                ...
                next_reward = next_q_values[next_action]
                next_reward *= (1 - self.epsilon)
                no_flap_reward, flap_reward = next_q_values
                next_reward += self.epsilon * (no_flap_reward * (1 - self.prob) + flap_reward * self.prob)
